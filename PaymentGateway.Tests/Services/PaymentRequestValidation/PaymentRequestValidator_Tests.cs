...
namespace PaymentGateway.Tests.Services.PaymentRequestValidation
{
    ...
    public class PaymentRequestValidator_Tests : IPaymentRequestValidator_Tests
    {
        ...
        public void Initialise()
        {
            ...
            _payment = new PaymentRequest("123456", DateTime.Now.AddYears(1), 10.51M, "GBP", 123);
        }

        [TestMethod]
        public void Constructor_RequestIsValid()
        {
            // Arrange
            ...
            // Assert
            Assert.IsTrue(result, "Payment should be invalid");
            Assert.IsTrue(reasons.Count == 0, "A reason should be provided");
        }

        [TestMethod]
        public void Constructor_CardNumberNullOrEmpty()
        {
            // Arrange
        ...
        [TestMethod]
        public void Constructor_CardNumberIsNotNumeric()
        {
            // Arrange
            _payment.CardNumber = "Hello";
        ...
        [TestMethod]
        public void Constructor_ExpiryDateInPast()
        {
            // Arrange
        ...
        [TestMethod]
        public void Constructor_PaymentValueLessThan0()
        {
            // Arrange
            _payment.Amount = 0;
        ...
        [TestMethod]
        public void Constructor_IncorrectCurrency()
        {
            // Arrange
        ...
        [TestMethod]
        public void Constructor_IncorrectCVV()
        {
            // Arrange
            _payment.Cvv = 12;
